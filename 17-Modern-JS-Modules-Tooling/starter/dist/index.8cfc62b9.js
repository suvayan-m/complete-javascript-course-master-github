...
(0, _shoppingCartJsDefault.default)(5, "Pencils");
(0, _shoppingCartJsDefault.default)(25, "Colours");
(0, _shoppingCartJsDefault.default)(2, "Erasers");
...
console.log((0, _shoppingCartJs.cart).find((el)=>el.quantity >= 10));
...
parcelHelpers.export(exports, "default", ()=>function(quantity, product) {
        cart.push({
            quantity,
            product
        });
